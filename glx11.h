...
#ifndef _WX_UNIX_GLX11_NEW_H_
#define _WX_UNIX_GLX11_NEW_H_
...
class WXDLLIMPEXP_GL wxGLContextX11_ : public wxGLContextBase
{
public:
    wxGLContextX11_(wxGLCanvasNew *win,
                const wxGLContextX11_ *other = NULL,
                const wxGLContextAttrs *ctxAttrs = NULL);
    virtual ~wxGLContextX11_();
...
private:
    ...
    wxDECLARE_CLASS(wxGLContextX11_);
};
...
// ----------------------------------------------------------------------------
#if 1
class WXDLLIMPEXP_GL wxGLCanvasX11_ : public wxGLCanvasBase
{
public:
...
public:
    ...
    {
        return wxGLCanvasX11_::InitDefaultVisualInfo(attribList);
    }
    ...
    {
        return wxGLCanvasX11_::GetDefaultXVisualInfo();
    }

    // and override this wxApp method to clean up
    virtual int OnExit() wxOVERRIDE
    {
        wxGLCanvasX11_::FreeDefaultVisualInfo();
