...
{
    if ( wxGLCanvasX11_::GetGLXVersion() >= 13 )
...
wxGLAttributes& wxGLAttributes::SampleBuffers(int val)
{
    ...
    if ( val >= 0 && wxGLCanvasX11_::IsGLXMultiSampleAvailable() )
    {
...
// ============================================================================
// wxGLContextX11_ implementation
// ============================================================================
...
wxIMPLEMENT_CLASS(wxGLContextX11_, wxObject);

wxGLContextX11_::wxGLContextX11_(wxGLCanvasNew *win,
                         const wxGLContextX11_ *other,
...
wxGLContextX11_::~wxGLContextX11_()
{
    if ( !m_glContext )
        return;
...
bool wxGLContextX11_::SetCurrent(const wxGLCanvasNew& win) const
{
    if ( !m_glContext )
        return false;
...
// version
/* static */
bool wxGLContextX11_::MakeCurrent(GLXDrawable drawable, GLXContext context)
{
    if (wxGLCanvasNew::GetGLXVersion() >= 13)
...
wxGLCanvasX11_::wxGLCanvasX11_()
{
    m_fbc = NULL;
    m_vi = NULL;
}

bool wxGLCanvasX11_::InitVisual(const wxGLAttributes& dispAttrs)
{
...
/* static */
bool wxGLCanvasX11_::IsGLXMultiSampleAvailable()
{
...
/* static */
bool wxGLCanvasX11_::InitXVisualInfo(const wxGLAttributes& dispAttrs,
                                    GLXFBConfig** pFBC,
...
bool wxGLCanvasBase::IsDisplaySupported(const wxGLAttributes& dispAttrs)
{
    ...
    bool isSupported = wxGLCanvasX11_::InitXVisualInfo(dispAttrs, &fbc, &vi);
...
XVisualInfo *wxGLCanvasX11_::ms_glVisualInfo = NULL;
GLXFBConfig *wxGLCanvasX11_::ms_glFBCInfo = NULL;

/* static */
bool wxGLCanvasX11_::InitDefaultVisualInfo(const int *attribList)
{
...
/* static */
void wxGLCanvasX11_::FreeDefaultVisualInfo()
{
    if ( ms_glFBCInfo )
    {
        XFree(ms_glFBCInfo);
...
/* static */
int wxGLCanvasX11_::GetGLXVersion()
{
...
bool wxGLCanvasX11_::SwapBuffers()
{
...
bool wxGLCanvasX11_::IsShownOnScreen() const
{
