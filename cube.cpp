///////////////////////////////////////////////////////////////////////////////
// Name:        cube.cpp
// Purpose:     wxGLCanvasNew demo program
// Author:      Julian Smart
// Modified by: Vadim Zeitlin to use new wxGLCanvasNew API (2007-04-09)
// Created:     04/01/98
...
TestGLContext::TestGLContext(wxGLCanvasNew *canvas)
             : wxGLContextNew(canvas)
{
    SetCurrent(*canvas);
...
TestGLContext& MyApp::GetContext(wxGLCanvasNew *canvas, bool useStereo)
{
...
wxBEGIN_EVENT_TABLE(TestGLCanvas, wxGLCanvasNew)
...
TestGLCanvas::TestGLCanvas(wxWindow *parent, int *attribList)
    ...
    // viewport settings.
    : wxGLCanvasNew(parent, wxID_ANY, attribList,
       ...
       : wxFrame(NULL, wxID_ANY, wxT("wxWidgets OpenGL Cube Sample"))
{
    ...
    wxLogStatus("Double-buffered display %s supported",
                wxGLCanvasNew::IsDisplaySupported(attribs) ? "is" : "not");
