...
class TestGLContext : public wxGLContextNew
{
public:
    TestGLContext(wxGLCanvasNew *canvas);
...
public:
    ...
    // the given canvas.
    TestGLContext& GetContext(wxGLCanvasNew *canvas, bool useStereo);
...
class TestGLCanvas : public wxGLCanvasNew
{
public:
